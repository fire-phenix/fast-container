package com.fire.phenix.container.fastmap;

import com.fire.phenix.container.callback.ExpireCallback;
...
public class FastMap<K, V> implements IFastMap<K, V> {
     ...
     */
    private static final List<FastMap> allExpiriableFastMaps = new Vector<>();
    ...
    public void init() {
        ...
        if (this.enableExpire) {
            ...
            allExpiriableFastMaps.add(this);
                ...
                synchronized (FastMap.class) {
                    if (scheduledExecutorService == null) {
                        ...
                        scheduledExecutorService.scheduleWithFixedDelay(() -> {
                            for (FastMap map : allExpiriableFastMaps) {
    ...
    public Long expire(K key, Long ms, ExpireCallback<K, V> callback) {
        ...
        try {
            ...
            if (callback != null) {
                ...
                FastMap.scheduledExecutorService.schedule(() -> clearExpireData("keyExpireCallback"), ms, TimeUnit.MILLISECONDS);
            }
